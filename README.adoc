...
:linkattrs:
:project-name: jdeprescan-gradle-plugin
...
You may run this plugin int a build that relies Java 8 as lojg as you configure a valid path to a JDK9+ installation
directory using the `javaHome` property, fo example
